...
public class OutputMappingTest extends AbstractTest {
	...
	@Test
	public void testOutputOffline() throws JAXBException, ClassNotFoundException, IOException, CoreServiceException,
			ComotException {
		...
		jaxbContext = JAXBContext.newInstance(at.ac.tuwien.dsg.cloud.salsa.common.cloudservice.model.CloudService.class, SalsaInstanceDescription_VM.class);
		jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		
		at.ac.tuwien.dsg.cloud.salsa.common.cloudservice.model.CloudService serviceState;
		serviceState = (at.ac.tuwien.dsg.cloud.salsa.common.cloudservice.model.CloudService) jaxbUnmarshaller.unmarshal(reader);
	...
	@Test
	public void testOutput() throws JAXBException, ClassNotFoundException, IOException, CoreServiceException,
			ComotException {
