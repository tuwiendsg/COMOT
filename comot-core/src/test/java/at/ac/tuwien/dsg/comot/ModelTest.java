...
public class ModelTest {
    ...
    public void buildCloudService() throws Exception {
        ...
        // Cassandra Data Node
        //
        ServiceNode cassandraDataNode =

                UnboundedSoftwareNode("CassandraNode").withName("Cassandra data node (multiple instances)")
        ...
        // OS Head Node
        //
        OperatingSystemNode cassandraHeadOsNode =

                OperatingSystemNode("OS_Headnode")
        ...
        // OS Data Node
        //
        OperatingSystemNode cassandraDataOsNode =

                OperatingSystemNode("OS_Datanode")
        ...
        CloudApplication application = CloudApplication("DaaSApp").consistsOfServices(daaSService);
