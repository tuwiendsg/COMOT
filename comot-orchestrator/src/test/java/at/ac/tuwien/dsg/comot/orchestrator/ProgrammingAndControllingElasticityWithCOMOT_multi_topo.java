 ...
 */
public class ProgrammingAndControllingElasticityWithCOMOT_multi_topo {
    ...
    public static void main(String[] args) {
        ...
        ServiceUnit momUnit = SingleSoftwareUnit("MOM")
                ...
                .deployedBy(SingleScriptArtifactTemplate("deployMOMArtifact", "deployQueue.sh"));
        ...
        ServiceUnit mqttUnit = SingleSoftwareUnit("MQTTQueueUnit")
                //load balancer must provide IP
        ...
        ServiceTemplate dataEndServiceTopology = ServiceTemplate("DataEndTopology")
         ...
         ServiceTemplate eventProcessingServiceTopology = ServiceTemplate("EventProcessingTopology")
                ...
                .andRelationships(
                        ...
                        ,
                         ConnectToRelation("eventProcessingToMOM_IP")
                        .from(dataControllerUnit.getContext().get("MOM_IP_information"))
         ...
         ServiceTemplate localProcessingTopology = ServiceTemplate("LocalProcessingTopology")
...
//                .withRsyblIP("109.231.121.8")
        ...
        CloudApplication cloudapp = CloudApplication.CloudApplication("IoTDaaS");
        cloudapp.consistsOfServices(dataEndServiceTopology, eventProcessingServiceTopology, localProcessingTopology);
        
        DefaultSalsaClient salsa = new DefaultSalsaClient();
        String xml = salsa.getToscaDescriptionBuilder().toXml(cloudapp);
